...
class Ludo:
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Lanzar", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
        ...
        Label(self.make_canvas,text="BOT",bg="#141414",fg="gold",font=("Arial",15,"bold")).place(x=15,y=15+140+50)
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Lanzar",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("sky_blue"))
    ...
    def instruction_btn_yellow(self):
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Lanzar",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        ...
        Label(self.make_canvas, text="", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 +7),y=15+(40*6+40*3)+40 + 110+50)
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Lanzar", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("green"))
        ...
        Label(self.make_canvas, text="", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100+(40*6+40*3+40*6+7), y=15+140+50)
    ...
    def main_controller(self, color_coin, coin_number):
        ...
        if  color_coin == "red":
            ...
            if self.move_red_counter == 106:
                messagebox.showwarning("Destino LLeagado","Reached at the destination")
            ...
            if self.move_red_counter == 106:
                messagebox.showwarning("Error","Ya llegaste a tu destino")
                ...
                if  self.sky_blue_coin_position[int(coin_number) - 1] + self.move_sky_blue_counter <= 106:
                   ...
                   messagebox.showerror("No posible","No hau camino disponible")
                ...
                messagebox.showerror("Mala eleccion", "Esta ficha no puede salir")
                self.num_btns_state_controller(self.block_value_predict[1][2])
                return
    ...
    def check_winner_and_runner(self,color_coin):
        ...
        if  destination_reached == 1:# If all coins in block reach to the destination, winner and runner check
            ...
            if self.take_permission == 1:# Ganador check
                if self.robo_prem == 1 and color_coin == "red":
                    messagebox.showinfo("Ganador", "Hurrah, Soy el ganador")
                else:
                    messagebox.showinfo("Ganador","Felicidades! Tu ganaste")
            elif self.take_permission == 2:# 1st runner check
                if self.robo_prem == 1 and color_coin == "red":
                    messagebox.showinfo("Ganador", "Hurrah! Soy el primero en llegar")
                else:
                    messagebox.showinfo("Ganador", "Wow! Tu eres el primer ganador")
            elif self.take_permission == 3:# 2nd runner check
                if self.robo_prem == 1 and color_coin == "red":
                    messagebox.showinfo("Resultado", "Soy el segundo, siempre hay otra oportunidad")
                else:
                    messagebox.showinfo("Resultado", "Eres el segundo....Mejor suerte a la proxima")
